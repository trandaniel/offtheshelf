...
var lc = document.getElementById("locality");
...
sn.onkeyup =rt.onkeyup =lc.onkeyup =cn.onkeyup = function (e) {
...
function initMap() {
  ...
  map = new google.maps.Map(document.getElementById('signupmap'), {
